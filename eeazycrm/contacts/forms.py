...
class NewContact(FlaskForm):
    ...
    parentphone = StringField('Phone Parent')
    classe = StringField('Class')
    school = StringField('School')
    nb_choix = StringField('Choise Number')
    avatar = FileField('Contact Avatar', validators=[FileAllowed(['jpg', 'jpeg', 'png'])])
    accounts = QuerySelectField('Assign To', query_factory=Account.account_list_query, get_pk=lambda a: a.id,
